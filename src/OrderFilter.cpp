...
{
    if (instrumentFilter_.match(params) && accountFilter_.match(params) && clearingFilter_.match(params))
    {
        for (FiltersT::const_iterator it = filters_.begin(); it != filters_.end(); ++it)
        {
            assert(nullptr != *it);
...
OrderStatusInFilter::OrderStatusInFilter(const ValuesT &values) : Impl::EnumInSetFilter<OrderStatus>(values) {}
...
SideInFilter::SideInFilter(const ValuesT &values) : Impl::EnumInSetFilter<Side>(values) {}
...
OrderTypeInFilter::OrderTypeInFilter(const ValuesT &values) : Impl::EnumInSetFilter<OrderType>(values) {}
...
TIFInFilter::TIFInFilter(const ValuesT &values) : Impl::EnumInSetFilter<TimeInForce>(values) {}
...
SettlTypeInFilter::SettlTypeInFilter(const ValuesT &values) : Impl::EnumInSetFilter<SettlTypeBase>(values) {}
...
CapacityInFilter::CapacityInFilter(const ValuesT &values) : Impl::EnumInSetFilter<Capacity>(values) {}
...
CurrencyInFilter::CurrencyInFilter(const ValuesT &values) : Impl::EnumInSetFilter<Currency>(values) {}
...
InstructionsInFilter::InstructionsInFilter(const ValuesT &values) : Impl::EnumSetInSetFilter<Instructions>(values) {}
