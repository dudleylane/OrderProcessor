...
struct OrderStateEvent
{
    ...
    OrderStateEvent(IdTValueGenerator *generator, Store::OrderDataStorage *orderStorage, const IdT &orderId,
...
public:
    ...
    const TradeExecEntry *trade() const
    {
        return trade_;
    }
...
public:
    ...
    const ExecCorrectExecEntry *correct() const
    {
        return correct_;
    }
