...
constexpr const char *toSQL(OrderType v)
{
    switch (v)
    {
    case MARKET_ORDERTYPE:
        return "MARKET";
    case LIMIT_ORDERTYPE:
        return "LIMIT";
    case STOP_ORDERTYPE:
        return "STOP";
    case STOPLIMIT_ORDERTYPE:
        return "STOPLIMIT";
    case FXSWAP_ORDERTYPE:
        return "FX_SWAP";
    default:
        return nullptr;
    }
...
constexpr const char *toSQL(Capacity v)
{
    switch (v)
    {
    case AGENCY_CAPACITY:
        return "AGENCY";
    case PRINCIPAL_CAPACITY:
        return "PRINCIPAL";
    case PROPRIETARY_CAPACITY:
        return "PROPRIETARY";
    case INDIVIDUAL_CAPACITY:
        return "INDIVIDUAL";
    case RISKLESS_PRINCIPAL_CAPACITY:
        return "RISKLESS_PRINCIPAL";
    case AGENT_FOR_ANOTHER_MEMBER_CAPACITY:
...
constexpr const char *toSQL(InstrumentType v)
{
    switch (v)
    {
    case EQUITY_INSTRUMENTTYPE:
        return "EQUITY";
    case FX_SPOT_INSTRUMENTTYPE:
        return "FX_SPOT";
    case FX_SWAP_INSTRUMENTTYPE:
        return "FX_SWAP";
    default:
        return nullptr;
    }
...
constexpr const char *toSQL(SettlTypeBase v)
{
    ...
    case _9_SETTLTYPE:
        return "T_PLUS_1";
    case _B_SETTLTYPE:
        return "BUYERS_OPTION";
    case _C_SETTLTYPE:
        return "SPECIAL_TRADE";
    case TENOR_SETTLTYPE:
        return "TENOR";
    default:
        return nullptr;
    }
