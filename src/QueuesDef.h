...
struct OrderCancelEvent : public EventBase
{
    ...
    OrderCancelEvent(const IdT &orderId, const std::string &reason) : cancelReason_(reason)
    {
        id_ = orderId;
    }
};
...
struct OrderChangeStateEvent : public EventBase
{
    ...
    OrderChangeStateEvent(const IdT &orderId, StateChangeType type) : changeType_(type)
    {
        id_ = orderId;
    }
};
...
struct ProcessEvent : public EventBase
{
    ...
    ProcessEvent(EventType type) : type_(type) {}
    ProcessEvent(EventType type, const IdT &id) : type_(type)
    {
        id_ = id;
    }
};
...
struct TimerEvent : public EventBase
{
    ...
    TimerEvent(const IdT &orderId, TimerType type) : timerType_(type)
    {
        id_ = orderId;
    }
};
