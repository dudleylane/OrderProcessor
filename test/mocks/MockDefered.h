...
public:
    MOCK_METHOD(void, process,
                (COP::OrdState::onTradeExecution & evnt, COP::OrderEntry *order, const COP::ACID::Context &cnxt),
                (override));
    MOCK_METHOD(void, process,
...
public:
    MOCK_METHOD(void, execute,
                (COP::Proc::DeferedEventFunctor * func, const COP::ACID::Context &cnxt, COP::ACID::Scope *scope),
                (override));
};
