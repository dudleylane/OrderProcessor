...
public:
    ...
    MOCK_METHOD(bool, getParentTransactions, (const COP::ACID::TransactionId &id, COP::ACID::TransactionIdsT *parent),
                (const, override));
    MOCK_METHOD(bool, getRelatedTransactions, (const COP::ACID::TransactionId &id, COP::ACID::TransactionIdsT *related),
                (const, override));
